...
def background_create():
    try:
        dossier = str(ROOT_LOCATION / "assets/images/images/underground/")
        ...
        background_img = pygame.image.load(ROOT_LOCATION / "assets/images/images/background.png")
...
def create_textures():
    try:
        block_dirt = pygame.transform.scale(
            pygame.image.load(ROOT_LOCATION / "assets/images/blocks/blocks/dirt.png"), (SIZE_BLOCK, SIZE_BLOCK)
        )
        block_grass_block = pygame.transform.scale(
            pygame.image.load(ROOT_LOCATION / "assets/images/blocks/blocks/grass_block.png"), (SIZE_BLOCK, SIZE_BLOCK)
        )
        block_stone = pygame.transform.scale(
            pygame.image.load(ROOT_LOCATION / "assets/images/blocks/blocks/stone.png"), (SIZE_BLOCK, SIZE_BLOCK)
        )
        block_stairs = pygame.transform.scale(
            pygame.image.load(ROOT_LOCATION / "assets/images/blocks/blocks/stairs.png"), (SIZE_BLOCK, SIZE_BLOCK)
        )
        block_iron_ore = pygame.transform.scale(
            pygame.image.load(ROOT_LOCATION / "assets/images/blocks/blocks/iron_ore.png"), (SIZE_BLOCK, SIZE_BLOCK)
        )
...
def play(compte_file):
    try:
        ...
        blue_storm = pygame.image.load(ROOT_LOCATION / "assets/images/UI/play/blue_storm.png")
        danger = pygame.image.load(ROOT_LOCATION / "assets/images/UI/play/danger.png")
        pression = pygame.image.load(ROOT_LOCATION / "assets/images/UI/play/pression.png")
        ...
        def inventory_image_make(collected_resources, font):
            image = pygame.image.load(ROOT_LOCATION / "assets/images/UI/Inventory/inventory.png")
            image = pygame.transform.scale(image, (600, 400))
            image_final = [image]
            resource_keys = list(collected_resources.keys())

            for i in range(len(resource_keys)):
                item_image = pygame.image.load(ROOT_LOCATION / f"assets/images/blocks/blocks/{resource_keys[i]}.png")
