...
def credit_menu():
    ...
    try:
        ...
        # === credits ===
        list_acteurs=[]
        creator_image = pygame.image.load(ROOT_LOCATION / "assets/images/images/creator.jpg")
        ...
        music_creator_img = pygame.image.load(ROOT_LOCATION / "assets/images/images/music_creator.png")
