...
def finish_menu(reward, compte_file):
    ...
    block_list_img=[block_dirt, block_grass_block, block_stairs, block_stone, block_iron_ore]
    ...
    data = save_load.build_data(file=compte_file, pseudo=data["pseudo"], money=(data["money"]+reward_final), inventory=data["inventory"])
